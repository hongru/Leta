...
;(function (win, undefined) {
    ...
    function interpret(whole, tag, idsAndClasses, wholeAttribute, attribute, qualifier, value, wholePseudo, pseudo, wholePseudoVal, pseudoVal) {
        ...
        if (pseudo && $qsa.pseudos[pseudo] && !$qsa.pseudos[pseudo](this, pseudoVal)) return false;
    ...
    function normalizeRoot(root) {
        if (!root) return doc;
        if (typeof root == 'string') return $qsa(root)[0];
        ...
        return function (s) {
            ...
            if (splittable.test(s)) {
                if (root[nodeType] !== 9) {
                    ...
                    if (!(nid = oid = root.getAttribute('id'))) root.setAttribute('id', nid = '__$qsameupscotty')
    ...
    selectNonNative = function (selector, root) {
        var result = [],
            ...
            // more complex selector, get `_$qsa()` to do the work for us
